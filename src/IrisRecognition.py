...
def codAndMaskOfIrisImage(irisImage):
    ...
    pupilCircle = irisP.findPupilInImage(irisImage,False)
    blackedPupilImage = irisP.drawCirclesOnImage(irisImage.copy(),[pupilCircle],False)
    irisCircle = irisP.findIrisInImage(blackedPupilImage,pupilCircle,False)
    #eyeImage, pupilCircle, irisCircle, numbOfLins = 10, pupilOffset = 0, showProcess = False):
    codeA = dataCod.codificateIrisData(irisImage,pupilCircle,irisCircle,40,0,False)
